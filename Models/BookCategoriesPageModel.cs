...
namespace Sut_Iulia_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Sut_Iulia_Lab2Context context,Book book)
        {
        ...
        public void UpdateBookCategories(Sut_Iulia_Lab2Context context,string[] selectedCategories, Book bookToUpdate)
        {
